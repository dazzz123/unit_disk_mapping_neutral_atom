...
# Input data
input_data = """
WeightedNode{Int64}[WeightedNode{Int64}((2, 1), 3), WeightedNode{Int64}((2, 2), 5), WeightedNode{Int64}((3, 2), 3), WeightedNode{Int64}((4, 2), 2), WeightedNode{Int64}((1, 3), 4), WeightedNode{Int64}((2, 3), 3), WeightedNode{Int64}((3, 3), 5), WeightedNode{Int64}((5, 3), 2), WeightedNode{Int64}((3, 4), 2), WeightedNode{Int64}((6, 4), 2), WeightedNode{Int64}((2, 5), 2), WeightedNode{Int64}((6, 5), 2), WeightedNode{Int64}((2, 6), 1), WeightedNode{Int64}((3, 6), 7), WeightedNode{Int64}((4, 6), 2), WeightedNode{Int64}((6, 6), 6), WeightedNode{Int64}((7, 6), 2), WeightedNode{Int64}((8, 6), 2), WeightedNode{Int64}((1, 7), 5), WeightedNode{Int64}((2, 7), 7), WeightedNode{Int64}((3, 7), 1), WeightedNode{Int64}((5, 7), 2), WeightedNode{Int64}((6, 7), 2), WeightedNode{Int64}((7, 7), 6), WeightedNode{Int64}((9, 7), 2), WeightedNode{Int64}((3, 8), 2), WeightedNode{Int64}((7, 8), 2), WeightedNode{Int64}((10, 8), 2), WeightedNode{Int64}((2, 9), 2), WeightedNode{Int64}((6, 9), 2), WeightedNode{Int64}((10, 9), 2), WeightedNode{Int64}((2, 10), 4), WeightedNode{Int64}((3, 10), 4), WeightedNode{Int64}((4, 10), 2), WeightedNode{Int64}((6, 10), 3), WeightedNode{Int64}((7, 10), 5), WeightedNode{Int64}((8, 10), 2), WeightedNode{Int64}((10, 10), 5), WeightedNode{Int64}((11, 10), 3), WeightedNode{Int64}((12, 10), -4), WeightedNode{Int64}((1, 11), 6), WeightedNode{Int64}((2, 11), 4), WeightedNode{Int64}((3, 11), 4), WeightedNode{Int64}((5, 11), 2), WeightedNode{Int64}((6, 11), 5), WeightedNode{Int64}((7, 11), 3), WeightedNode{Int64}((9, 11), 2), WeightedNode{Int64}((10, 11), 3), WeightedNode{Int64}((11, 11), 5), WeightedNode{Int64}((3, 12), -1), WeightedNode{Int64}((7, 12), -2), WeightedNode{Int64}((11, 12), -3)]"""
pattern = r"WeightedNode{Int64}\(\((\d+), (\d+)\), ([\d.-]+)\)"

# Extract matche
matches = re.findall(pattern, input_data, re.IGNORECASE)

# Process matches
coordinates = [(int(x), int(y)) for x, y, _ in matches]
weights = [float(weight) for _, _, weight in matches]
